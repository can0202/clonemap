...
// PROJECT
export const IS_CHANGE_SUB_TYPE = 'is_change_sub_type';
export const RESET_IS_CHANGE_SUB_TYPE = 'reset_is_change_sub_type';

// ONCLICK MAP HIDE FOOTER
export const IS_HIDE_FOOTER = 'is_hide_footer';
...
export const SAVE_LANGUAGE_LOCALE = 'SAVE_LANGUAGE_LOCALE';
